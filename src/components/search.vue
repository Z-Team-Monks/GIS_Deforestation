<template>
  <div>
    <v-container style="margin-top: 5%; !important">
      <v-row>
        <v-col cols="8">
          <div style="margin-top: 2%; !important;margin-bottom: 5%; !important">
            <l-map style="height: 250px" :zoom="zoom" :center="searchResults[0].location.coordinates">
              <l-tile-layer
                :url="url"
              ...
              <div v-else>
                <l-marker :lat-lng="searchResults[0].location.coordinates"
                  ><l-icon
                    :icon-size="dynamicSize"
                    :icon-anchor="dynamicAnchor"
                    icon-url="https://www.freeiconspng.com/uploads/agricultural-sciences-icon-10.png"
          ...
          <v-row style="margin-top: 5%">
            <v-col  v-for="(searchres, index) in  searchResults" :key="index" cols="6">
        ...
        <v-col style="margin-top: 3%" cols="4">
          ...
          <h3>REGIONS</h3>
                  ...
                  <div style="padding:4%" v-for="(region, index) in regions" :key="index">
                      <v-btn style="font-weight: 900; margin-bottom:1%" @click="setSelected(region._id)" >
                      {{region._id}}
                  </v-btn>
                  </div>
  ...
  methods: {
    ...
    async locateMe() {
      ...
      try {
        ...
        this.location = { lat: currentLoc.coords.latitude, lon: currentLoc.coords.longitude }
